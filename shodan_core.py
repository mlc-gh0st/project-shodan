...
# This file contains the Sacred Canon, High Priests, and Resonance Keys.

# 1. THE SACRED CANON
# [NOTE] Keys are normalized (punctuation stripped) during the check.
SACRED_CANON = {
...
def check_sacred_canon(title):
    """Checks if the title exists in the Sacred Canon (fuzzy match)."""
...
def calculate_shodan_weight(title, director, year_str, country, fmt="Digital", genre="", plot=""):
    """The central logic for determining resonance."""
    # 0. SACRED CHECK
